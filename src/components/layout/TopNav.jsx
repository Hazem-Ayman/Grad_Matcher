...
export default function TopNav({ unreadNotificationsCount, onSignOut, hideNavigation }) {
  return (
    <header className={`${hideNavigation ? 'block' : 'hidden md:block'} sticky top-0 z-50 bg-gray-950/80 backdrop-blur-md border-b border-gray-800 px-6 py-4`}>
